...
s3://idseq-public-references/consensus-genome/kraken_coronavirus_db_only.tar.gz | The smaller kraken2 database was taken form the CZ Biohub sc2 pipeline configuration in July 2020.
