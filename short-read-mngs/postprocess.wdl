...
workflow idseq_postprocess {
  input {
    ...
    File nt_db = "s3://~{idseq_db_bucket}/ncbi-sources/~{index_version}/nt"
    File nt_loc_db = "s3://~{idseq_db_bucket}/alignment_data/~{index_version}/nt_loc.db"
    File nr_db = "s3://~{idseq_db_bucket}/ncbi-sources/~{index_version}/nr"
    File nr_loc_db = "s3://~{idseq_db_bucket}/alignment_data/~{index_version}/nr_loc.db"
